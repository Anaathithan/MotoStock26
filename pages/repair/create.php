...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($bikeNo === '') {
        ...
        $errors['bikeNo'] = 'Enter a valid vehicle number (letters, numbers, hyphens only, 2–20 chars).';
    }
...
<head>
  ...
  <title>New Repair Job — MotoStock26</title>
...
<div class="main-wrap">
  <div class="topbar">
    <div>
      ...
      <div class="topbar-breadcrumb">Repair Jobs → Create</div>
    </div>
  </div>
        ...
        <form method="post" id="repairForm" novalidate>
          ...
          <div class="form-group">
            ...
            <textarea name="problem" id="problem" rows="4"
                      ...
                      placeholder="Describe the issue in detail… (5–500 characters)"
...
function validateBikeNo() {
  ...
  if (val === '') {
    ...
    bikeNoInput.classList.add('is-invalid'); bikeNoInput.classList.remove('is-valid');
    if (errEl) { errEl.textContent = 'Letters, numbers and hyphens only (2–20 chars).'; errEl.style.display = 'block'; }
    return false;
  }
