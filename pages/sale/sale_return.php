...
// â”€â”€ Handle Return â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
<head>
    ...
    <title>Sale Return #<?= $saleID ?> â€” MotoStock26</title>
...
<div class="main-wrap">
    <div class="topbar">
        <div>
            ...
            <div class="topbar-breadcrumb">Sales â€º Return</div>
        </div>
        <a href="view_invoice.php?saleID=<?= $saleID ?>" class="btn btn-secondary btn-sm">â† Cancel</a>
    </div>
    ...
    <div class="main-content">
        ...
        <div class="alert alert-warning mb-3">
            âš  <strong>You are about to return this sale.</strong>
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <textarea name="reason" class="form-control" rows="3" required
                            placeholder="e.g. Wrong part, damaged item, customer changed mindâ€¦"><?= htmlspecialchars($_POST['reason'] ?? '') ?></textarea>
                    </div>
